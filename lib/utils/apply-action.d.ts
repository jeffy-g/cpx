 ...
 * @private
 */
export declare function applyAction(pattern: string, options: Pick<TCopyOptions, "includeEmptyDirs" | "dereference">, action: (arg0: string) => Promise<void>): Promise<void>;
